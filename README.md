...
The function DbBuilder receive to parameters the name of the database file name and an optional [**DbCreationOptions**](../../src/common/DbCreationOptions.ts) object. If you do not pass the last parameter, a default one will be created, but you cannot set the db version.
